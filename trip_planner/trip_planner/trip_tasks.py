...
class TripTasks:
    def identify_task(self, agent, origin, cities, interests, trip_date):
        return Task(
    ...
    def gather_task(self, agent, origin, interests, trip_date):
        return Task(
            description=dedent(f"""
            ...
            agent=agent,
            expected_output=(
                "Comprehensive city guide including hidden gems, "
                "cultural hotspots, and practical travel tips"
            )
        )

    def plan_task(self, agent, origin, interests, trip_date):
        return Task(
            description=dedent(f"""
            ...
            agent=agent,
            expected_output=(
                "Complete expanded travel plan with daily schedule, "
